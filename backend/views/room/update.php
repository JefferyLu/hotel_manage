    ...
    <form class="layui-form" id="dataSet" onsubmit="return present();">
		...
		<div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="room_id" lay-verify="required" class="layui-input" value="<?= $model->room_id ?>">
            </div>
            ...
            <div class="layui-input-inline">
                <select name="cate_id" class="valid">
                    <?php foreach ($cate_list as $value) : ?>
                        <option value="<?= $value->id ?>" <?php if ($value->id == $model->cate_id){ echo 'selected'; }?>><?= $value->cate_name ?></option>
                    <?php endforeach; ?>
                </select>
            </div>
        </div>
            ...
            <div class="layui-input-inline">
                <select name="floor" class="valid">
                    <?php foreach (Room::$floor as $key => $value) : ?>
                        <option value="<?= $key ?>" <?php if ($key == $model->floor){ echo 'selected'; }?>><?= $value ?></option>
                    <?php endforeach; ?>
                </select>
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="price" lay-verify="required" class="layui-input" value="<?= $model->price ?>">
            </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="discount_price" class="layui-input" value="<?= $model->discount ?>">
            </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="member_price" lay-verify="required" class="layui-input" value="<?= $model->member_price ?>">
            </div>
            <div class="layui-form-mid layui-word-aux">必填 单位元</div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="vip_price" lay-verify="required" class="layui-input" value="<?= $model->vip_price ?>">
            </div>
            <div class="layui-form-mid layui-word-aux">必填 单位元</div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <select name="status" class="valid">
                    <?php foreach (Room::$status as $key => $value) : ?>
                        <option value="<?= $key ?>" <?php if ($key == $model->status){ echo 'selected'; }?>><?= $value ?></option>
                    <?php endforeach; ?>
                </select>
            </div>
        </div>
...
<script>
     ...
     */
    function present() {
        dialog.presentForm('<?= Url::to(['room/update']) ?>');
        return false;
    }
