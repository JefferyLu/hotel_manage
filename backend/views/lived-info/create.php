...
<div class="x-body">
    <form class="layui-form" id="dataSet" onsubmit="return present();">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="lived_name" lay-verify="required" class="layui-input">
            </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="radio" class="layui-radio" name="is_breakfast" value="1" checked>是</input>
                <input type="radio" class="layui-radio" name="is_breakfast" value="0">否</input>
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">
            ...
            <div class="layui-input-inline">
                <input type="radio" class="layui-radio" name="is_alarm" value="1" checked>是</input>
                <input type="radio" class="layui-radio" name="is_alarm" value="0">否</input>
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">
...
<script>
     ...
     */
    function present() {
        dialog.presentForm('<?= Url::to(['lived-info/create']) ?>');
        return false;
    }
